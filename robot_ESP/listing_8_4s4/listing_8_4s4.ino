...
#include "irq_sonar.h"  //Работа с сонаром
...
{
  //протестиуем сонар -
  // затем закоомментировать эти три строки, включая return;
 // Serial.println(dist_sm);
 // delay(300);
 // return;
  // строки выше заккоментировать после тестирования сонара
