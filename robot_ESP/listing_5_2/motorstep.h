...
int32_t maxSPEED = 450000; //Скорость шагов за 100 сек
// ВНИМАНИЕ!!!! Установка минимальной скорости менее 10000 приведет к ошибке
int32_t minSPEED =  10000; //Скорость шагов за 100 сек
